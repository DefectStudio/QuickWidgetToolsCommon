...
def _normalize_path(input_path):
    ...
    # Normalize as a Windows file-system path regardless of the Python host.
    # This accepts forward, backward, mixed, and doubled separators while
    # keeping forward slashes as the canonical format stored in Unreal config.
